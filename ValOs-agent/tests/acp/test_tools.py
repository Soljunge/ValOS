...
COMMON_VALOS_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_valos_tools_have_kind(self):
        """Every common valos-agent tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_VALOS_TOOLS:
