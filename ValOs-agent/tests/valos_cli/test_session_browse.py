"""Tests for the interactive session browser (`valos-agent sessions browse`).
...
from valos_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """valos-agent sessions browse should be parseable."""
        from valos_cli.main import main as _main_entry
