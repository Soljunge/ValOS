...
import valos_cli.doctor as doctor
import valos_cli.gateway as gateway_cli
from valos_cli import doctor as doctor_mod
from valos_cli.doctor import _has_provider_env_config
...
def test_run_doctor_sets_interactive_env_for_tool_checks(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(doctor_mod, "VALOS_HOME", valos_home)
    monkeypatch.delenv("VALOS_INTERACTIVE", raising=False)

    seen = {}

    def fake_check_tool_availability(*args, **kwargs):
        seen["interactive"] = os.getenv("VALOS_INTERACTIVE")
        raise SystemExit(0)
