...
class TestToolsetConsistency:
    ...
    def test_valos_platforms_share_core_tools(self):
        """All valos-agent-* platform toolsets should have the same tools."""
        platforms = ["valos-agent-cli", "valos-agent-telegram", "valos-agent-discord", "valos-agent-whatsapp", "valos-agent-slack", "valos-agent-signal", "valos-agent-homeassistant"]
