...
class TestWriteDenyExactPaths:
    ...
    def test_valos_env(self):
        path = os.path.join(str(Path.home()), ".valos-agent", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_valos_config_not_env(self):
        path = os.path.join(str(Path.home()), ".valos-agent", "config.yaml")
