...
class TestCronjobRequirements:
    def test_requires_no_crontab_binary(self, monkeypatch):
        ...
        # because valos-agent uses an internal scheduler, not system crontab.
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        monkeypatch.delenv("VALOS_INTERACTIVE", raising=False)
        monkeypatch.setenv("VALOS_GATEWAY_SESSION", "1")
        monkeypatch.delenv("VALOS_EXEC_ASK", raising=False)
    ...
    def test_accepts_exec_ask(self, monkeypatch):
        monkeypatch.delenv("VALOS_INTERACTIVE", raising=False)
        monkeypatch.delenv("VALOS_GATEWAY_SESSION", raising=False)
        monkeypatch.setenv("VALOS_EXEC_ASK", "1")
...
class TestScheduleCronjob:
    ...
    def test_thread_id_captured_in_origin(self, monkeypatch):
        ...
        monkeypatch.setenv("VALOS_SESSION_CHAT_ID", "123456")
        monkeypatch.setenv("VALOS_SESSION_THREAD_ID", "42")
