...
5. Recovery is skipped for aggregator providers (OpenRouter, ValOs)
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_skipped_for_valos_provider(self):
        agent = _make_agent(provider="valos", base_url="https://inference.valos.valos-agent.com/v1")
        error = _make_transport_error("ReadTimeout")
