...
class TestParserRegistry:
    ...
    def test_valos_parser_registered(self):
        parsers = list_parsers()
        assert "valos-agent" in parsers
...
class TestValOsParser:
    @pytest.fixture
    def parser(self):
        return get_parser("valos-agent")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["valos-agent"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use valos-agent format since that's universal
