...
"""
    ...
    assert "Tyler Williams > Active Projects: ValOs" in entries
...
def test_skill_installs_cleanly_under_skills_guard():
    ...
    # valos_config_mod  — print statements in the post-migration summary that
    #                      tell the user to *review* ~/.valos-agent/config.yaml;
    ...
    KNOWN_FALSE_POSITIVES = {"agent_config_mod", "python_os_environ", "valos_config_mod"}
