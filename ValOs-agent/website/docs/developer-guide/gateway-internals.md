...
The messaging gateway is the long-running process that connects ValOs to external platforms.
...
- `~/.valos-agent/gateway.json`
- selected bridged values from `~/.valos-agent/config.yaml`
