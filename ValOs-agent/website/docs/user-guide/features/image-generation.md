...
ValOs can generate images from text prompts using FAL.ai's **FLUX 2 Pro** model with automatic 2x upscaling via the **Clarity Upscaler** for enhanced quality.
...
When you ask ValOs to generate an image:
...
Simply ask ValOs to create an image:
