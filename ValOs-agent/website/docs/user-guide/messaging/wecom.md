...
description: "Connect ValOs to WeCom via the AI Bot WebSocket gateway"
---

# WeCom (Enterprise WeChat)

Connect ValOs to [WeCom](https://work.weixin.qq.com/) (企业微信), Tencent's enterprise messaging platform. The adapter uses WeCom's AI Bot WebSocket gateway for real-time bidirectional communication — no public endpoint or webhook needed.
...
Or set environment variables in `~/.valos-agent/.env`:
