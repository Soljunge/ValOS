...
title: "SMS (Twilio)"
description: "Set up ValOs as an SMS chatbot via Twilio"
---

# SMS Setup (Twilio)

ValOs connects to SMS through the [Twilio](https://www.twilio.com/) API. People text your Twilio phone number and get AI responses back — same conversational experience as Telegram or Discord, but over standard text messages.
...
- **aiohttp** — `pip install 'valos-agent[sms]'`
...
If you're running ValOs locally, use a tunnel to expose the webhook:
...
Text your Twilio number — ValOs will respond via SMS.
...
3. Check ValOs gateway logs for Twilio API errors
