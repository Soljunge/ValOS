...
slug: /
sidebar_position: 0
title: "ValOs Documentation"
description: "The self-improving AI agent built by ValOs. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# ValOs

The self-improving AI agent built by [ValOs](https://valos-agent.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/horatiu.sol/valos-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 💬 **[Messaging Gateway](/docs/user-guide/messaging)** | Set up Telegram, Discord, Slack, WhatsApp, Signal, Matrix, Feishu/Lark, WeCom, SMS, Email, webhooks, Home Assistant, or API Server |
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend ValOs safely |
| 🧭 **[Use MCP with ValOs](/docs/guides/use-mcp-with-valos-agent)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with ValOs](/docs/guides/use-voice-mode-with-valos-agent)** | Hands-on setup and usage patterns for ValOs voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define ValOs' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of ValOs |
...
- **Lives where you do** — CLI, Telegram, Discord, Slack, WhatsApp, Signal, Matrix, Mattermost, Feishu/Lark, WeCom, SMS, Email, webhooks, Home Assistant, and API Server from one gateway
- **Built by model trainers** — Created by [ValOs](https://valos-agent.com), the lab behind ValOs, Nomos, and Psyche. Works with [ValOs Portal](https://portal.valos-agent.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [ValOs](https://valos-agent.com) — the lab behind ValOs, Nomos, and Psyche models
