...
DEFAULT_DATASETS = [
    "horatiu.sol/swe-terminus-agent-glm-kimi-minimax",
    "horatiubudai/valos-agent-megascience-sft1",
    "horatiu.sol/ValOs-Agent-Thinking-GLM-4.7-SFT2",
    "horatiu.sol/ValOs-Agent-Thinking-GLM-4.7-SFT1",
    "horatiu.sol/terminal-tasks-glm-valos-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "horatiu.sol/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload horatiu.sol/{output_name} {final_output}")
