...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full ValOs toolsets (CLI + messaging platforms)
    #
    ...
    "valos-agent-email": {
        "description": "Email bot toolset - interact with ValOs via email (IMAP/SMTP)",
        "tools": _VALOS_CORE_TOOLS,
        "includes": []
    },

    "valos-agent-mattermost": {
    ...
    "valos-agent-sms": {
        "description": "SMS bot toolset - interact with ValOs via SMS (Twilio)",
        "tools": _VALOS_CORE_TOOLS,
        "includes": []
    },
    ...
    "valos-agent-gateway": {
        ...
        "tools": [],
        "includes": ["valos-agent-telegram", "valos-agent-discord", "valos-agent-whatsapp", "valos-agent-slack", "valos-agent-signal", "valos-agent-homeassistant", "valos-agent-email", "valos-agent-sms", "valos-agent-mattermost", "valos-agent-matrix", "valos-agent-dingtalk", "valos-agent-feishu", "valos-agent-wecom", "valos-agent-webhook"]
    }
}
