#!/usr/bin/env python3
"""
SWE Runner with ValOs Trajectory Format

A runner that uses ValOs-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the ValOs-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses ValOs-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in ValOs format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches ValOs-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using ValOs-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with ValOs Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses ValOs-Agent's built-in execution environments
    and outputs trajectories in ValOs-Agent format.
    """
    ...
    def _convert_to_valos_format(
        ...
        """
        Convert internal message format to ValOs trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to ValOs trajectory format
        trajectory = self._convert_to_valos_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with ValOs trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with ValOs Trajectory Format")
    print("=" * 60)
