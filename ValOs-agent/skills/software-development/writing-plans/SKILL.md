...
version: 1.1.0
author: ValOs (adapted from obra/superpowers)
license: MIT
metadata:
  valos-agent:
...
> **For ValOs:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use ValOs tools to understand the project:
