...
metadata:
  valos-agent:
    ...
    related_skills: [claude-code, valos-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the ValOs terminal. Codex is OpenAI's autonomous coding agent CLI.
