...
metadata:
  valos-agent:
    ...
    related_skills: [codex, valos-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the ValOs terminal. Claude Code is Anthropic's autonomous coding agent CLI.
