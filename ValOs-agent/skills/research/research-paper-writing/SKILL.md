...
This skill is designed for the ValOs agent. It uses ValOs tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other ValOs skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.valos-agent/plans/` | `skill_view("plan")` |
