...
Built for [ValOs](https://github.com/horatiu.sol/valos-agent). Usable in any coding agent. Canonical source lives here; synced to [`horatiu.sol/valos-agent/skills/creative/ascii-video`](https://github.com/horatiu.sol/valos-agent/tree/main/skills/creative/ascii-video) via PR.
