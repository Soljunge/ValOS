...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("valos-agent")
        class ValOsToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "valos-agent", "mistral", "llama3_json")
...
from environments.tool_call_parsers.valos_parser import ValOsToolCallParser  # noqa: E402, F401
