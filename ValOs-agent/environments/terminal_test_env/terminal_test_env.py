...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from ValOs"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from ValOs",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from ValOs",
    },
    {
...
class TerminalTestEnv(ValOsAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/valos-agent/.env.
        """
        env_config = TerminalTestEnvConfig(
            ...
            tokenizer_name="horatiu.sol/q-30b-t-h45-e1",
