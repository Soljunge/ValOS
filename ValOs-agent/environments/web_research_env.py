...
Inspired by: GroceryMind — production ValOs agent doing live web research
             across German grocery stores (firecrawl + valos-agent)
"""
...
# Ensure valos-agent root is on path
...
class WebResearchEnvConfig(ValOsAgentEnvConfig):
...
class WebResearchEnv(ValOsAgentBaseEnv):
    """
