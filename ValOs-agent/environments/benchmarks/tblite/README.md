...
- **Dataset (ours):** [horatiu.sol/openthoughts-tblite](https://huggingface.co/datasets/horatiu.sol/openthoughts-tblite)
- **Docker images:** `valos-agent/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `horatiu.sol/terminal-bench-2`  | `horatiu.sol/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
