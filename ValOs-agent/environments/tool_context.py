...
ALL valos-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all valos-agent tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any valos-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("VALOS_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("VALOS_QUIET", None)
            else:
                os.environ["VALOS_QUIET"] = _prev_quiet
