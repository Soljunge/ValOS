...
import { ListItem } from "@/ui/ui/components/list-item";
import { Segmented } from "@/ui/ui/components/segmented";
import { Spinner } from "@/ui/ui/components/spinner";
import { Badge } from "@/ui/ui/components/badge";
import { Card, CardContent, CardHeader, CardTitle } from "@/ui/ui/components/card";
    ...
    async (id: string) => {
      try {
        const res = await fetch(api.exportSessionUrl(id), {
          credentials: "include",
          headers: {
            "X-ValOs-Session-Token":
              (window as unknown as { __VALOS_SESSION_TOKEN__?: string })
                .__VALOS_SESSION_TOKEN__ ?? "",
          },
        });
