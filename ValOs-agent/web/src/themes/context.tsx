...
const STORAGE_KEY = "valos-dashboard-theme";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + ValOs-blue rebrand.
  "lens-5i": "valos-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `valos_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "valos-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-valos-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-valos-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. ValOs Blue) doesn't leave its values behind when the user
