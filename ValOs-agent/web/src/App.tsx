...
import { SelectionSwitcher } from "@/ui/ui/components/selection-switcher";
...
import { useBelowBreakpoint } from "@/ui/hooks/use-below-breakpoint";
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "border border-current/35 bg-midground/10 text-midground",
        "font-mondwest text-display text-xl leading-none",
      )}
...
const SIDEBAR_COLLAPSED_KEY = "valos-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="valos-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="valos-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateValOs,
      runningLabel: t.status.updatingValOs,
      spin: false,
    },
  ];
