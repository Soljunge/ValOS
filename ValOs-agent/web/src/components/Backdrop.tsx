import { useGpuTier } from "@/ui/hooks/use-gpu-tier";

/**
 * Replicates the visual layer stack of the previous dashboard backdrop without
 * external design-system dependencies. Defaults match the ValOs teal dark
 * preset; the deep canvas
 ...
 *         Both LENS_0-style dark themes and the LENS_5I-style ValOs Blue
 ...
 *   z-2   generated low-contrast texture, opacity 0.033, difference
        ...
        style={
          {
            ...
            backgroundImage:
              "var(--theme-asset-bg, radial-gradient(circle at 20% 20%, currentColor 0 1px, transparent 1px), radial-gradient(circle at 70% 60%, currentColor 0 1px, transparent 1px))",
            backgroundSize: "var(--component-backdrop-background-size, 64px 64px)",
            backgroundPosition:
