...
import { BottomSheet } from "@/ui/ui/components/bottom-sheet";
 ...
 * themes from `~/.valos/dashboard-themes/*.yaml` use their API-provided
...
function ThemeSwatch({ theme }: { theme: DashboardTheme }) {
  // Inverted themes (ValOs Blue / future lens themes) author their palette
