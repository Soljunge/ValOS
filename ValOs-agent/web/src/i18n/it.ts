...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateValOs: "Aggiorna ValOs",
    updatingValOs: "Aggiornamento di ValOs…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin ValOs (parità con `valos plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.valos/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.valos/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.valos/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge ValOs da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni ValOs in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa ValOs di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando ValOs rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "ValOs sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
