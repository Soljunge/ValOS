...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateValOs: "Update ValOs",
    updatingValOs: "Updating ValOs…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update ValOs plugins (`valos plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.valos/plugins/?",
    removeHint: "Only user-installed plugins under ~/.valos/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.valos/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible ValOs badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning ValOs session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run ValOs more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once ValOs sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "ValOs is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
