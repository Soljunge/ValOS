...
DEFAULT_DB_PATH = get_valos_home() / "state.db"
...
class SessionDB:
    ...
    # With multiple valos-agent processes (gateway + CLI sessions + worktree agents)
    ...
    def _init_schema(self):
        ...
        if row is None:
            ...
            if current_version < 6:
                ...
                # providers that replay reasoning (OpenRouter, OpenAI, ValOs).
    ...
    def get_messages_as_conversation(self, session_id: str) -> List[Dict[str, Any]]:
        ...
        for row in rows:
            ...
            # that replay reasoning (OpenRouter, OpenAI, ValOs) receive
