...
Data file: $VALOS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_VALOS_HOME = Path(os.environ.get("VALOS_HOME", Path.home() / ".valos-agent"))
DATA_DIR = _VALOS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
