...
4. Name the token (e.g., "ValOs"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.valos-agent/.env`:
...
```bash
CANVAS="python $VALOS_HOME/skills/productivity/canvas/scripts/canvas_api.py"
