...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_valos_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/valos-agent")
            async def handle_valos_command(ack, command):
                await ack()
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        """Handle /valos-agent slash command."""
        ...
        from valos_cli.commands import slack_subcommand_map
