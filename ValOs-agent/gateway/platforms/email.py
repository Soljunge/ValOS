"""
Email platform adapter for the ValOs gateway.

Allows users to interact with ValOs by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        msg_id = f"<valos-agent-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
