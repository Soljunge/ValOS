...
~/.valos-agent/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_valos_home() / "channel_directory.json"
...
def build_channel_directory(adapters: Dict[Any, Any]) -> Dict[str, Any]:
    ...
    # Platforms that can't enumerate chats pull known targets from session history.
    from gateway.channel_registry import session_directory_platform_names

    for plat_name in session_directory_platform_names():
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_valos_home() / "sessions" / "sessions.json"
