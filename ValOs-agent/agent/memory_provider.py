...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - valos_home (str): The active VALOS_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.valos-agent``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "valos-agent").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'valos-agent memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], valos_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'valos-agent memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``valos_home`` is the active VALOS_HOME directory path.
