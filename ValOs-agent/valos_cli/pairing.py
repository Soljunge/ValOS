...
Usage:
    valos-agent pairing list              # Show all pending + approved users
    valos-agent pairing approve <platform> <code>  # Approve a pairing code
    valos-agent pairing revoke <platform> <user_id> # Revoke user access
    valos-agent pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle valos-agent pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: valos-agent pairing {list|approve|revoke|clear-pending}")
        print("Run 'valos-agent pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'valos-agent pairing list' to see pending codes.\n")
