"""ValOs CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.valos-agent/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "ValOs"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ ValOs "       # Response box header label
...
.. code-block:: python
    ...
    from valos_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "ValOs"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.valos-agent/skins/
...
Drop a YAML file in ``~/.valos-agent/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces VALOS_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces VALOS_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic ValOs — grayscale",
        "colors": {
            "banner_border": "#7a7a7a",
            "banner_title": "#a0a0a0",
            ...
            "prompt": "#d6d6d6",
            "input_rule": "#7a7a7a",
            "response_border": "#a0a0a0",
            "session_label": "#b0b0b0",
            "session_border": "#8a8a8a",
        },
        "spinner": {
        ...
        "branding": {
            "agent_name": "ValOs",
            "welcome": "Welcome to ValOs! Type your message or /help for commands.",
            "goodbye": "Goodbye! V",
            "response_label": " V ValOs ",
            "prompt_symbol": "❯ ",
